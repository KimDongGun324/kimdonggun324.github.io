...
<div class="three-column-wrapper">
  ...
  <div class="column">
    ...
    <div style="margin-bottom: 20px;">
      <h4 style="font-size:0.85em; color:#86868b; margin-bottom:10px; font-weight:700;">GRAPHICS THEORY & MATH</h4>
      <ul>
        <li class="text-card">
    ...
    <div style="margin-bottom: 20px;">
      <h4 style="font-size:0.85em; color:#86868b; margin-bottom:10px; font-weight:700;">SHADER IMPLEMENTATION</h4>
      <ul>
        <li class="text-card">
    ...
    <div style="margin-bottom: 20px;">
      <h4 style="font-size:0.85em; color:#86868b; margin-bottom:10px; font-weight:700;">C++ & ENGINE ARCHITECTURE</h4>
      <ul>
        <li class="text-card">
          <a href="./03_Engine_CPP/README.md">
            <span class="text-card-title">📂 C++ Deep Dive</span>
            <span class="text-card-desc">메모리 관리(CS), 자료구조 및 최적화</span>
          </a>
        </li>
        <li class="text-card">
  ...
  <div class="column">
    ...
    <div class="gallery-item">
      <a href="./03_Engine_CPP/README.md">
        ...
        <div class="gallery-info">
          <strong>C++ Memory Optimization</strong>
          <span>Smart Pointer & Custom Allocator</span>
        </div>
      </a>
    </div>
    ...
    <div class="gallery-item">
      <a href="./03_Engine_CPP/UE5_Analysis.md">
        ...
        <div class="gallery-info">
          <strong>UE5 Source Analysis</strong>
          <span>Rendering Pipeline Deep Dive</span>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="column">
    ...
    <div class="gallery-item">
      <a href="./02_Shader_Lab/README.md">
        ...
        <div class="gallery-info">
          <strong>Ocean Simulation</strong>
          <span>Gerstner Wave / HLSL</span>
        </div>
      </a>
    </div>
