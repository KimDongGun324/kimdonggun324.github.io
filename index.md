...
<div class="three-column-wrapper">
  ...
  <div class="column">
    ...
    <h4 style="font-size:0.85em; color:#86868b; margin-bottom:15px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; margin-top: 40px;">
      Graphics Theory & Math
    </h4>
    <ul>
      <li class="text-card">
